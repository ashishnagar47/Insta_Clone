            ...
            <div className="home">
                {
                    data.map(item=>{
                        return(
                            ...
                            <h5><Link to={item.postedBy._id!==state._id?"/profile/"+item.postedBy._id:"/profile"}>{item.postedBy.pic}{item.postedBy.name}</Link> {item.postedBy._id==state._id 
                                ...
                                <p>{item.body}</p>
                                {
                                    item.comments.map(record=>{
                                        return(
                                            ...
                                            {/* {record.postedBy._id==state._id  && <i className="material-icons" style={{float:"right", cursor:"pointer"}} onClick={()=>deleteComment(record.text,record.postedBy)} >delete</i> }  */}
                                            </h6>
                                        )
                                    })
                                }
